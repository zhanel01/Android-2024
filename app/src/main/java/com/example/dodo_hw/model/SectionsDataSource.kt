    ...
    fun getPizzas(): List<Pizza> {
        return listOf(
            Pizza(
                ...
                image = ContextCompat.getDrawable(context, R.drawable.bavarskaya) ,
                startPrice = 2700
            ),
            Pizza(
                name = "Наруто Пицца",
                description = "Куриные кусочки, моцарелла, ананасы, фирменный соус альфредо, соус терияки",
                image =ContextCompat.getDrawable(context, R.drawable.naruto),
                startPrice = 3900
            ),
            Pizza(
                name = "Вау! Кебаб",
                description = "Кебаб из говядины, соус ранч, моцарелла, сладкий перец, томаты, красный лук, фирменный томатный соус",
                image = ContextCompat.getDrawable(context, R.drawable.kebab),
                startPrice = 2900
            ),
            Pizza(
                name = "Пепперони с грибами",
                description = "Пикантная пепперони из цыпленка, моцарелла, шампиньоны, фирменный соус альфредо",
                image =ContextCompat.getDrawable(context, R.drawable.pepwithmush),
                startPrice = 2000
            ),
            Pizza(
                name = "Сырная",
                description = "Моцарелла, сыры чеддер и пармезан, соус альфредо",
                image = ContextCompat.getDrawable(context, R.drawable.cheese),
                startPrice = 1900
            ),
            Pizza(
                name = "Додо",
